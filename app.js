...
if (edad >= 18) { alert("Bienvenid@ " + usuario + " tienes " + edad + " años," + " estas habilitado para navegar por esta pagina")} else { alert ( "No estás habilitado para navegar por esta página ya que no eres mayor de 18 años")
...
//         case "2":
//             return totalConTarjeta
             
           
//         default: 
//            return alert ("No se puede calcular el costo, intente nuevamente") 
//     }
...
// let precioFinalConDescuento = calcularDescuento

// let precioFinalMasInteres = calcularRecargo
